...
class BasePage(object):
    ...
    def saveScreen(self):
        resultPath = "d:\\selenium"
        logPath = time.strftime('%Y%m%d%H%M%S', time.localtime())
        screenshotPath=os.path.join(resultPath, logPath)
        name='screen'+time.asctime()+'.png'
        screen_img = os.path.join(screenshotPath, name)
        self.driver.save_screenshot(screen_img)
        print screen_img
